...
-----------1-300 Alchemy
	[7002] = {
		...
		items = {
			...
			[2] = { str = "#DOQUESTMateriais Aprox. Necessarios#: #VIDEO60#x #TURNINPeacebloom# #VIDEO60#x #TURNINSilverleaf# #VIDEO75#x #TURNINEmpty Vial#" ..
...
-----------1-300 Blacksmithing
	[7003] = {
		...
		items = {
			...
			[2] = { str = "#DOQUESTMateriais Aprox. Necessarios#: #VIDEO90#x #TURNINRough Stone# #VIDEO380#x #TURNINCopper Bar# #VIDEO20#x #TURNINCoarse Stone# " ..
			...
			"Se voce tiver sorte de ter o plano Mithril Spurs, faca esses ate 275." },
			[19] = { str = "#VIDEO[250-260]# 20x Dense Sharpening Stones (1x Dense Stone)" },
			[20] = { str = "#VIDEO[260-265]# #ACCEPTArmorsmiths# faca o seguinte: " ..
					"5x Earthforged Leggings (16x Mithril Bar, 2x Core of Earth)" },
			[21] = { str = "#VIDEO[260-265]# #ACCEPTWeaponsmiths# faca qualquer um dos seguintes: " ..
			...
			[22] = { str = "Va ate Derotain Mudsipper em Gadgetzan e entregue Thorium Bars ate conseguir os planos de Imperial Plate Belt, Bracers e Boots." },
	...
	[7004] = {
		...
		items = {
			...
			[3] = { str = "#VIDEO[40-90]# 60x Smoked Bear Meat (1x Bear Meat) " ..
				"Va ate The Sepulcher em Silverpine Forest e compre a receita de Smoked Bear Meat " ..
				"de Andrew Hilbert. Mate Grizzled bears em Silverpine Forest para conseguir Bear Meat." },
			[4] = { str = "#VIDEO[90-125]# 40x Dig Rat Stew (1x Dig Rat) " ..
				"Va ate Grub em The Barrens. Ele esta em uma torre perto de Grosh'gek Farm. " ..
				"(Logo ao norte da estrada entre Crossroads e Ratchet.) " ..
				"Pegue a quest de Dig Rat Stew. Mate Dig Rats ate ter 30 a mais " ..
				"do que a quest precisa. Complete a quest e cozinhe." },
			[5] = { str = "#VIDEO[125-175]# 60x Hot Lion Chops (1x Lion Meat, 1x Hot Spices) " ..
				"Para treinar como Expert cook, va ate Shadowprey Village e compre " ..
				"o Expert Cooking Book de Wulan. Va ate Crossroads e compre a " ..
				"receita de Hot Lion Chops de Zargh e 60 Hot Spices. " ..
				"Mate Mountain Lions em Hillsbrad Foothills para conseguir Lion Meat." },
			[6] = { str = "#VIDEO[175-200]# 30x Roast Raptor (1x Raptor Flesh, 1x Hot Spices) " ..
				"Va ate Grom'gol e compre a receita de Roast Raptor de Nerrist e cerca de 30 Hot Spices. " ..
				"Mate Raptors em volta de Grom'gol para conseguir Raptor Flesh." },
			[7] = { str = "#VIDEO[200-225]# 30x Spider Sausage (2x White Spider Meat) " ..
				"Va ate o treinador e aprenda Spider Sausage. " ..
				"Mate Darkfangs em Dustwallow Marsh para conseguir White Spider Meat." },
			[8] = { str = "#VIDEO[225]# Hora da Quest de Cooking! " ..
				"Va ate Gadgetzan. Fale com Dirge Quikcleave. Pegue a Quest de Artisan Cooking. " ..
				"Pegue a receita de Tender Wolf Steaks. Voce precisa de 12 Giant Eggs, 10 Zesty Clam Meat e 20 Alterac Swiss. " ..
				"Alterac Swiss: Thunderbluff Innkeeper " ..
				"Giant Eggs: Owlbeasts em The Hinterlands " ..
				"Zesty Clam Meat: Steamwheedle Port nas Turtles " ..
				"Va ate Bloodvenom Post em Felwood e compre a receita de Monster Omelet de Bale e 150 Soothing Spices." },
			[9] = { str = "#VIDEO[225-250]# 25x Monster Omelet (1x Giant Egg, 2x Soothing Spices) OU " ..
				"25x Tender Wolf Steaks (1x Tender Wolf Meat, 1x Soothing Spices)" },
			[10] = { str = "#VIDEO[250-285]# 35x Charred Bear Kabobs (1x Bear Flank) OU " ..
				"35x Juicy Bear Burger (1x Bear Flank)" },
			[11] = { str = "#VIDEO[285-300]# 20x Smoked Desert Dumplings (1x Sandworm Meat, 1x Soothing Spice)" ..
				"Va ate Cenarion Hold em Silithus. Fale com Calandrath para a cadeia de quests de Desert Recipe." ..
				"Quando chegar na terceira quest, voce recebera a receita de Smoked Desert Dumplings." ..
				"Mate Dredge Crushers e Strikers para conseguir Sandworm Meat." ..
				"Voce so vai precisar de cerca de 10 a mais do que a quest precisa, mais as Soothing Spices (uns 20)." },
		}
	},
	...
	[7005] = {
		...
		items = {
			...
			[3] = { str = "#VIDEO[40-75]# 40x Smoked Bear Meat (1x Bear Meat) " ..
				"Va ate Drac Roughcut em Thelsamar, Loch Modan e compre a receita de Smoked Bear Meat. " ..
				"Mate bears em Loch Modan para conseguir Bear Meat." },
			[4] = { str = "#VIDEO[75-85]# 10x Crab Cake (1x Crawler Meat) " ..
				"Mate Crawlers em Darkshore e Westfall para conseguir Crawler Meat. " ..
				"Voce vai precisar de cerca de 10. Nao venda nenhuma Crawler Claws que encontrar. Vamos precisar depois." },
			[5] = { str = "#VIDEO[85-100]# 20x Cooked Crab Claw (1x Crab Claw, 1x Mild Spice) " ..
				"Va ate Stormwind City e compre a receita de Cooked Crab Claw de Kendor Kabonka. " ..
				"Compre cerca de 20 Mild Spices. Volte para Darkshore ou Westfall para mais claws." },
			[6] = { str = "#VIDEO[100-130]# 30x Seasond Wolf Kabob (2x Lean Wolf Flank, 1x Stormwind Seasoning Herbs) " ..
				"Va ate Chef Grual em Darkshire. Pegue a Quest de Seasond Wolf Kabobs. Pegue Stormwind Seasoning Herbs de Felcia Grump no Trade District. " ..
				"Mate Ravagers e Wolves em Duskwood para conseguir Lean Wolf Flank." },
			[7] = { str = "#VIDEO[130-175]# 50x Curiosly Tasty Omelet (1x Raptor Egg, 1x Hot Spice) " ..
				"Treine Expert Cooking com Shandrina perto de Mystral Lake em Ashenvale. " ..
				"Va ate Kendor Kabonka em Stormwind para comprar a receita de Curiosly Tasty Omelet. " ..
				"Mate Raptors em Arathi Highlands para conseguir Raptor Eggs. (Guarde qualquer Raptor Meat!)" },
			[8] = { str = "#VIDEO[175-200]# 30x Roast Raptor (1x Raptor Flesh, 1x Hot Spices) " ..
				"Va ate Rebel Camp em STV e compre a receita de Roast Raptor de Corporal Bluth e cerca de 40 Hot Spices. " ..
				"Mate Raptors em volta da Gurubashi Arena." },
			[9] = { str = "#VIDEO[200-225]# 30x Spider Sausage (2x White Spider Meat)" ..
				"Va ate o treinador e aprenda Spider Sausage." ..
				"Mate Darkfangs em Dustwallow Marsh para conseguir White Spider Meat." },
			[10] = { str = "#VIDEO[225]# Hora da Quest de Cooking! " ..
				"Va ate Gadgetzan. Fale com Dirge Quikcleave. Pegue a Quest de Artisan Cooking. " ..
				"Pegue a receita de Tender Wolf Steaks. Voce precisa de 12 Giant Eggs, 10 Zesty Clam Meat e 20 Alterac Swiss. " ..
				"Alterac Swiss: Ben Trias no Trade District de Stormwind " ..
				"Giant Eggs: Owlbeasts em The Hinterlands " ..
				"Zesty Clam Meat: Steamwheedle Port nas Turtles " ..
				"Va ate Talonbranch Glade em Felwood e compre a receita de Monster Omelet de Malygen e 150 Soothing Spices." },
			[11] = { str = "#VIDEO[225-250]# 25x Monster Omelet (1x Giant Egg, 2x Soothing Spices) OU " ..
				"25x Tender Wolf Steaks (1x Tender Wolf Meat, 1x Soothing Spices)" },
			[12] = { str = "#VIDEO[250-285]# 35x Charred Bear Kabobs (1x Bear Flank) OU" ..
				"35x Juicy Bear Burger (1x Bear Flank)" },
...
-----------1-300 Enchanting
	[7006] = {
		...
		items = {
			...
			[2] = { str = "#DOQUESTMateriais Aprox. Necessarios#: " ..
			...
			[23] = { str = "#VIDEO[250-270]# 20x Lesser Mana Oil (3x Dream Dust, 2x Purple Lotus, 1x Crystal Vial) " ..
				"Voce pode comprar essa formula de Kania em Cenarion Hold, Silithus." },
			[24] = { str = "#VIDEO[270-290]# 20x Enchant Shield - Greater Stamina (10x Dream Dust) OU " ..
...
-----------1-300 Leatherworking
	[7008] = {
		...
		items = {
			...
			[2] = { str = "#VIDEO[1-205]# #DOQUESTMateriais Aprox. Necessarios#: " ..
			...
			[16] = { str = "#VIDEO[205-250]# #DOQUESTMateriais Aprox. Necessarios#:                                            " ..
			...
			[32] = { str = "#VIDEO[250-300]# #DOQUESTMateriais Aprox. Necessarios#: #VIDEO160#x #TURNINThick Leather# #VIDEO470#x #TURNINRugged Leather#" },
...
-----------1-300 Tailoring
	[7009] = {
		...
		items = {
			...
			[2] = { str = "#DOQUESTMateriais Aprox. Necessarios#: #VIDEO160#x #TURNINLinen Cloth# #VIDEO200#x #TURNINWool Cloth# #VIDEO760#x #TURNINSilk Cloth# " ..
